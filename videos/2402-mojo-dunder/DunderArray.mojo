...
struct DunderArray[dtype: DType = DType.float64](
    Stringable, Intable, CollectionElement, Sized
):
    ...
    fn __invert__(self) -> Self:
        if _mlirtype_is_eq[Scalar[dtype], Bool]():
            ...
            fn wrapper[simd_width: Int, rank: Int = 1](idx: StaticIntTuple[rank]):
                new_array._ptr.simd_store[simd_width](
                    idx[0], ~self._ptr.simd_load[simd_width](idx[0])
                )
    ...
    fn __lshift__(self, p: Int) -> Self:
        if _mlirtype_is_eq[Scalar[dtype], Int32]():
            ...
            fn wrapper[simd_width: Int, rank: Int = 1](idx: StaticIntTuple[rank]):
                new_array._ptr.simd_store[simd_width](
                    idx[0], self._ptr.simd_load[simd_width](idx[0]) << p
                )
    ...
    fn __and__(self, other: Self) -> Self:
        if ~_mlirtype_is_eq[Scalar[dtype], Float64]():
            ...
            fn wrapper[simd_width: Int, rank: Int = 1](idx: StaticIntTuple[rank]):
                new_array._ptr.simd_store[simd_width](
                    idx[0],
                    self._ptr.simd_load[simd_width](idx[0])
                    & other._ptr.simd_load[simd_width](idx[0]),
                )
    ...
    fn _reduce_sum(self) -> Self:
        ...
        vectorize[vectorize_reduce, simd_width](self.numel)
        return reduced

    fn _elemwise_transform[
        ...
        fn elemwise_vectorize[simd_width: Int](idx: Int) -> None:
            new_array._ptr.simd_store[simd_width](
                idx, func[dtype, simd_width](self._ptr.simd_load[simd_width](idx))
            )
        ...
        fn elemwise_vectorize[simd_width: Int](idx: Int) -> None:
            new_array._ptr.simd_store[simd_width](
                ...
                func[dtype, simd_width](
                    self._ptr.simd_load[simd_width](idx), SIMD[dtype, simd_width](s)
                ),
            )
    ...
    fn _r_elemwise_scalar_math[
        ...
        fn elemwise_vectorize[simd_width: Int](idx: Int) -> None:
            new_array._ptr.simd_store[simd_width](
                idx,
                func[dtype, simd_width](
                    SIMD[dtype, simd_width](s), self._ptr.simd_load[simd_width](idx)
                ),
            )
    ...
    fn _elemwise_array_math[
        ...
        fn elemwise_vectorize[simd_width: Int](idx: Int) -> None:
            new_array._ptr.simd_store[simd_width](
                idx,
                func[dtype, simd_width](
                    self._ptr.simd_load[simd_width](idx),
                    other._ptr.simd_load[simd_width](idx),
                ),
            )
    ...
    fn _elemwise_pow(self, p: Int) -> Self:
        ...
        fn tensor_scalar_vectorize[simd_width: Int](idx: Int) -> None:
            new_array._ptr.simd_store[simd_width](
                idx, math.pow(self._ptr.simd_load[simd_width](idx), p)
            )
